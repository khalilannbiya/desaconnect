...
<section
    ...
    <h1 class="text-center text-3xl md:text-4xl lg:text-5xl font-bold">Riwayat Pengajuan<span class="text-vermillion">
            Surat</span>
    </h1>
            ...
            <a href="{{ route('complainant.documents.show', $document->id) }}">
                <div class="flex flex-col lg:flex-row lg:items-center gap-2 md:gap-5 lg:gap-4">
                    <div class="px-4 lg:px-0 flex flex-col gap-2">
                        ...
                        <h2
                            class="capitalize text-xl lg:text-2xl text-black group-active:text-vermillion group-hover:text-vermillion group-hover:transition-all group-hover:duration-500  font-bold">
                            {{ $document->document_type }}
                        </h2>
                        <hr class="border-1 border-davys-grey">
                        <p class="text-xs lg:text-sm text-davys-grey leading-5 font-medium">{{
