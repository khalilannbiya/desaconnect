...
<div class="px-4 py-3 mb-8 bg-gray-800 rounded-lg shadow-md">
    <form action="{{ route('admin.users.store') }}" method="post">
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400">Nama <span class="text-red-500">*</span></span>
        ...
        <div class="mt-4 text-sm">
            ...
            <div class="mt-2">
                <label class="inline-flex items-center text-gray-400">
                    <input type="radio"
                        class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple focus:shadow-outline-gray"
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400 ">Email <span class="text-red-500">*</span></span>
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400 ">NIK <span class="text-red-500">*</span></span>
            <input id="nik" name="nik" type="text" value="{{ old('nik') }}"
                class="block w-full mt-1 text-sm text-gray-300 bg-gray-700 border-gray-600 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple focus:shadow-outline-gray form-input"
                placeholder="Contoh: 3216008200927888" />
            @error('nik')
            <span class="text-xs text-red-400">
                {{ $message }}
            </span>
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400 ">No.HP <span class="text-red-500">*</span></span>
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400">Alamat <span class="text-red-500">*</span></span>
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400">Password <span class="text-red-500">*</span></span>
        ...
        <label class="block mt-4 text-sm">
            <span class="text-gray-400 ">Konfirmasi Password <span class="text-red-500">*</span></span>
