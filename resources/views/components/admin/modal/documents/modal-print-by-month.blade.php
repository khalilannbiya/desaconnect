<div x-show="isModalPrintByMonthOpen" x-transition:enter="transition ease-out duration-150"
    ...
    <div x-show="isModalPrintByMonthOpen" x-transition:enter="transition ease-out duration-150"
        ...
        <!-- Modal body -->
        <form
            action="{{ auth()->user()->role_id === 2 ? route('staff.documents.generate-pdf-all') : route('admin.documents.generate-pdf-all') }}"
            method="get">
            <div class="mt-4 mb-6">
                <!-- Modal title -->
                <p class="mb-2 text-lg font-semibold text-gray-300">
                    Cetak Pengajuan Berdasarkan Bulan
                </p>
                <!-- Modal description -->
